...
1 Workbook First, Polish Second: Finish the Day 7 Sprint Workbook tasks completely before starting the UI/UX refinement pass.
2 Review Like a Senior Team: Have Claude critique the product as a Product Designer, UI/UX Designer, and Senior Engineer would — not just as the original builder.
3 States Are Part of Polish: Loading, empty, and error states, plus accessibility, get the same refinement attention as the visible happy-path UI.
4 Same Vision, Better Feel: Every refinement improves layout, spacing, typography, or interaction — none of it changes what the product is.
